  ...
  if(isset($_POST["title"]))
   {
        ...
        $sql="INSERT into blog(blog_title,picture,blog_description,author,date_post) value(?,?,?,?,?)";
        $queryResult = mysqli_query($conn, $sql);

    $stmt=$conn->prepare($sql);
      $stmt->bind_param("sssss",$title,$picture,$description,$author,$date);
    $stmt->execute();
             //upload file
...
<div id="wrapper">
  ...
  <div id="page-wrapper">
    ...
    <div class="panel panel-default">
      <div class="panel-heading">
        <h1 class="text-muted" style="margin-left: 40%"> ADD POST</h1>
      </div>
      <!-- /.panel-heading -->
        ...
        <div class="panel panel-default">
          ...
          <div class="panel-body">
            <div class="list-group">
                  <form action="addpost.php" method="post" enctype="multipart/form-data" name="form1">
