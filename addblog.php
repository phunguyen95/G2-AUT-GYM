...
<div id="wrapper">
  ...
  <div id="page-wrapper">
    ...
    <div class="panel panel-default">
      <div class="panel-heading">
        <h1 class="text-muted" style="margin-left: 40%"> ADD BLOGS</h1>
      </div>
      <!-- /.panel-heading -->
        ...
        <div class="panel panel-default">
          ...
          <div class="panel-body">
            <div class="list-group">
                ...
                <form action="insert_blog_process.php" method="post" enctype="multipart/form-data">
                  <h2><strong>Create new blog</strong></h2><br>
                  <table>
                      <tr>
                          <td class="add">Title<span style="color: red">*</span>: </td>
                          <td><input type="text" name="title" style="width: 308px" required></td>
                      </tr>
                      <tr>
                          <td class="add">Description<span style="color: red">*</span>: </td>
                          <td><textarea id="description" name="description" rows="12" cols="42" required></textarea></td>
                      </tr>
                      <tr>
                          <td class="add">Choose Image:</td>
                          <td><input type="file" name="file" id="file" accept="image/*"></td>
                      </tr>
                      <tr>
                          <td class="add">Date<span style="color: red">*</span>: </td>
                          <td><input type="date" name="date" style="width: 200px" <?php echo 'value="'.date("d/m/Y").'"';?> required></td>
                      </tr>
                      <tr>
                          <td class="add">Author<span style="color: red">*</span>: </td>
                          <td><input type="text" id="author" name="author" style="width: 200px" placeholder="Username..." required></input></td>
                      </tr> 
                  </table>
                  <br/>
                  <table>
