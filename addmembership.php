...
<div id="wrapper">
  ...
  <div id="page-wrapper">
    ...
    <div class="panel panel-default">
      <div class="panel-heading">
        <h1 class="text-muted" style="margin-left: 40%"> ADD MEMBERSHIPS</h1>
      </div>
          ...
          <div class="panel-body">
                ...
                <form action="insert_membership_process.php" method="post" enctype="multipart/form-data">
                  ...
                  <table class="table">
                      ...
                      <tr>
                          <td class="add">First name<span style="color: red">*</span>: </td>
                          <td><input type="text" name="fname" style="width: 160px" pattern= "[a-zA-Z0-9,.! ]+" title="can only contain alphanumeric chacracters including space, comma, period (full stop) and exclamation point" required></td>
                      </tr>
                      <tr>
                          <td class="add">Last name<span style="color: red">*</span>: </td>
                          <td><input type="text" name="lname" style="width: 160px" pattern= "[a-zA-Z0-9,.! ]+" title="can only contain alphanumeric chacracters including space, comma, period (full stop) and exclamation point" required></td>
                      </tr>
                      <tr>
                      ...
                      <tr>
                          <td class="add">Address<span style="color: red">*</span>: </td>
                          <td><input type="text" name="address" style="width: 303px" required></td>
                      </tr>
                      <tr>
                          <td class="add">Contact<span style="color: red">*</span>: </td>
